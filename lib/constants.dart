...
const String kInvalidEmailError = "Por favor valide seu Email";
const String kPassNullError = "Por favor digite sua senha";
const String kShortPassError = "A senha é muito curta";
const String kMatchPassError = "A senha não não bate!";
const String kNamelNullError = "Por favor digite seu nome";
const String kPhoneNumberNullError = "Por favor digite seu número";
